# -*- coding: utf-8 -*-
"""\
12-14-1203: Removed nlkt dependency for PyTeaser
...
version = load_source("version", os.path.join("python-goose", "goose", "version.py"))
...
try:
    with open(os.path.join(os.path.dirname("python-goose"), 'README.rst')) as f:
